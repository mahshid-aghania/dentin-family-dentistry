      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-gray max-w-none">
            ...
            <h2 className="text-2xl font-bold text-[#002C29] mb-4">Daily Oral Hygiene Habits</h2>
            ...
            <h2 className="text-2xl font-bold text-[#002C29] mb-4">The Role of Nutrition in Oral Health</h2>
            <p className="text-[#555574] leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-[#002C29] mb-4">Benefits of Maintaining Oral Health</h2>
            <p className="text-[#555574] leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-[#002C29] mb-4">Regular Dental Visits Are Essential</h2>
            <p className="text-[#555574] leading-relaxed mb-4">
