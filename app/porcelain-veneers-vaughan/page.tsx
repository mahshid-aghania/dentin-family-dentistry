    ...
    <>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">What Are Porcelain Veneers?</h2>
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-3">Veneers Can Correct:</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm">
              ...
              <div className="font-semibold text-gray-900 text-sm">— Kimia KH</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Porcelain Veneers FAQs</h2>
          <div className="space-y-4">
            {[
              {
